...
public class AnimateOfRedPacketsByVideoviewView extends LinearLayout {
    ...
    public AnimateOfRedPacketsByVideoviewView(Context context) {
        super(context);
        init();
    }


    public AnimateOfRedPacketsByVideoviewView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public AnimateOfRedPacketsByVideoviewView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public void play(){
